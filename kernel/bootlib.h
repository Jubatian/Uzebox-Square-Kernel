...
/* A macro to expand a file name for appropriate parameters for FS_Find */

#define  FS_FIND_NAME(c0,c1,c2,c3,c4,c5,c6,c7,e0,e1,e2) \
    ((uint16_t)(c0) << 8) + (uint16_t)(c1),\
    ((uint16_t)(c2) << 8) + (uint16_t)(c3),\
    ((uint16_t)(c4) << 8) + (uint16_t)(c5),\
    ((uint16_t)(c6) << 8) + (uint16_t)(c7),\
    ((uint16_t)(e0) << 8) + (uint16_t)(e1),\
    ((uint16_t)(e2) << 8)
